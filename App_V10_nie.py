...
#         st.write("Welcome to the AI-powered Virus Prediction App! Enter patient details and symptoms to get dynamic virus predictions.")
#         st.warning("**Disclaimer:** This tool assists research and should not replace medical advice.")

#     # --- About Page ---
#     elif page == "About":
#         st.title("About This App")
#         st.write("This application leverages AI to predict potential viral infections based on symptoms and demographics. It integrates supervised learning models trained on real-world medical data.")
...
#         # --- Predict Button ---
#         if st.button("Predict"):
#             st.info("Running AI models... Please wait.")
...
#                 input_df = input_df.astype(np.int32)

#                 probs = binary_model.predict_proba(input_df)[0]
#                 binary_pred = "Dengue" if np.argmax(probs) == 0 else "Non-Dengue"
